...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerUserProfileException(UserException exception){
        System.out.println("UserProfileException hatası...: "+ exception.toString());

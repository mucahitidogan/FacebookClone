...
## Docker Imaje oluşturmak
    ...
    docker build -t mucahitdogan/java7-configservergit:v.1.0 .

    docker build -t mucahitdogan/java7-authservice:v.1.0 .

    docker build -t mucahitdogan/java7-userservice:v.1.0 .

    docker build -t mucahitdogan/java7-gatewayservice:v.1.0 .